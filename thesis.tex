...
% Słowa kluczowe:
\keywords{USOS, Android, Kotlin, mobile}
...
związanych z edukacją'', realizowanego w~latach 2016-2019. W~ramach wstępu przedstawimy rys
historyczny rozwoju aplikacji.

Proces tworzenia aplikacji rozpoczął się w~roku 2016. Autorami kodu w~pierwszej iteracji
rozwoju byli programiści z~Uniwersytetu Łódzkiego. Zakończyli oni prace nad kodem aplikacji
w~styczniu 2018~r. Na tym etapie prac aplikacja posiadała moduły: aktualności, ankiety, oceny,
...
Od kwietnia 2018~r. aplikacja była rozwijana przez nas w~ramach pracy magisterskiej oraz
przez studentkę Politechniki Warszawskiej w~ramach praktyk, a~później także pracy
inżynierskiej. Ten etap możemy podzielić na dwie fazy -- przygotowanie do wdrożenia
produkcyjnego i~rozwój funkcjonalności.

Przygotowanie do wdrożenia oznaczało gruntowny refaktoring kodu, czego istotnym elementem
była migracja z Javy na Kotlin (o~wyborze technologii obecnych w~produkcyjnej wersji
aplikacji opowiemy w~odpowiednim rozdziale), zastąpienie wadliwego rozwiązania problemu
...
Etap rozwoju funkcjonalności rozpoczął się jeszcze w~lipcu 2018 roku, do lipca 2019 roku
aplikacja otrzymała moduły: protokoły, sprawdziany, moje legitymacje i eID, kalendarz
akademicki. Ponadto gruntownemu przeprojektowaniu uległ moduł ocen oraz dostosowaliśmy
aplikację do potrzeb związanych z~dostępnością.

W~kolejnych rozdziałach przedstawimy wizję aplikacji i~wymagania, wykorzystane technologie,
wskażemy istotne szczegóły implementacji i~przedstawimy stan wdrożenia Mobilnego USOS
w~skali kraju.
...
Z~tego powodu na ekranie powitalnym aplikacji pojawiają się logo sponsorów,
a~po wybraniu z~menu głównego opcji ,,O~aplikacji'' na ekranie, poza wersją aplikacji,
pojawia się notka o~własności i~źródle finansowania.
...
Ze względu na fakt, że potrzeby studenta są analogiczne, co w przypadku ocen -- powiadomienia
...
mogą być progi punktowe na koniec przedmiotu.

Z~perspektywy pracownika, oczekiwane funkcjonalności aplikacji mobilnej różnią się od tego,
co jest dostępne dla pracownika w USOSweb. Mając na uwadze wygodę użytkowania, zdecydowano
...
uwierzytelnianiu np. na uczelnianej bibliotece.

Drugim z~modułów potomnych jest moduł Moje eID. Ma on za zadanie umożliwić użytkownikowi
...
roku akademickiego. Moduł ten miał powstać w~oparciu o~funkcjonujący w~systemie USOS
...
interesujące go zdarzenia, dni wolne, kiedy powinien przygotować się do sesji, itd. 
...
o~terminach wniosków o~stypendium.

\section{Informacje o uczelni}

Ostatnim z~dużych modułów dostępnych w~aplikacji są informacje o~uczelni. Można je
podzielić na dwie części -- przewodnik i~mapa.

Przewodnik, jak sama nazwa wskazuje, ma w kilku zakładkach zbierać przydatne, zwłaszcza
nowych studentów informacje o~uczelni i~wydziale studenta. Zawartość przewodnika jest
wypełniana przez uczelnię w~ramach dostarczonego modułu do wspomnianego wcześniej
USOSadm. Dzięki przewodnikowi student, zwłaszcza świeżo upieczony, otrzyma w jednym
...
przy użyciu klawiatury bądź technologii wspomagających między kolejnymi elementami 
interfejsu powinno dawać logiczną nawigację, bez nieoczywistych skoków. 
...
W~tej kategorii zwróciliśmy uwagę przede wszystkim na obsługę języka.
Domyślny język aplikacji i~język treści powinien być możliwy do sprawdzenia przez
oprogramowanie asystujące, tak żeby na przykład można było wybrać przy text-to-speech
lektora w~odpowiednim języku.
...
produkcyjne zakończyło 14 uczelni \cite{news-musosumk}\cite{news-musospwste}, 7 kolejnych w~lipcu 2019 r. było w~fazie testów.
...
\begin{itemize}
	\item Dla każdej wersji aplikacji przygotowujemy prostą uwagę do sklepu w~wersji
	polskiej i~angielskiej. Uczelnia przekleja tę uwagę do formularza w~konsoli
	Google Play.
...
aplikacja otrzyma kilka nowych modułów, w~tym rejestracje na zajęcia. W~międzyczasie
rozpoczął się port Mobilnego USOS na system iOS, jego pierwsza wersja została wdrożona
już m.in. na UW\cite{uw-ios}\cite{appstore}.

Zdecydowanie nie możemy uznać aplikacji za projekt zakończony, w~zależności od pomysłów
uczelni otrzyma prawdopodobnie szereg kolejnych przydatnych funkcjonalności. W~ramach tej
...
perspektywie na to, że liczba uczelni korzystających z~Mobilnego USOS nie zamknie się na
kilkunastu.
...
\bibitem[23a]{news-musospwste} MUCI, \textit{Mobilny USOS PWSTE w sklepie Google Play}, \url{https://www.usos.edu.pl/node/4170/mobilny-usos-pwste-w-sklepie-google-play}. [Dostęp: 2019-07-19].
...
\bibitem[32]{mifare} NXP Semiconductors Austria GmbH, \textit{Mifare ICs}, \url{https://www.mifare.net/en/products/chip-card-ics/}. [Dostęp: 2019-07-18].

\bibitem[33]{mobywatel} Ministerstwo Cyfryzacji, \textit{mDokumenty. Potwierdzaj tożsamość smartfonem},\\ \url{https://obywatel.gov.pl/dokumenty-i-dane-osobowe/mdokumenty-potwierdzaj-tozsamosc-smartfonem}. [Dostęp: 2019-07-18].

\bibitem[34]{uw-ios} Uniwersytet Warszawski,
\textit{Aplikacja Mobilny USOS już dostępna na iOS},\\
\url{https://www.uw.edu.pl/aplikacja-mobilny-usos-juz-dostepna-na-ios/}. [Dostęp: 2019-07-18].

\bibitem[35]{appstore} Apple Inc.,
\textit{Aplikacja Mobile USOS UW w App Store},\\
\url{https://apps.apple.com/us/app/mobilny-usos-uw/id1447221710}. [Dostęp: 2019-07-18].
